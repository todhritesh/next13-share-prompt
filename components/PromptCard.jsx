    ...
    <div className="prompt_card">
        <div className="flex justify-between items-start gap-5">
            <div className="flex-1 flex justify-start gap-3 items-center cursor-pointer ">
                ...
                <div className="flex flex-col">
                    <h3 className="font-semibold font-satoshi text-gray-500">
...

        {
            session?.user.id === post.creator._id && pathname ==="/profile" && (
                <div className="mt-4 flex-center gap-5 border-t pt-3 border-gray-300">
                    <div onClick={()=>handleEdit(post)} className="font-inter text-sm green_gradient cursor-pointer">
                        Edit
                    </div>
                    <div onClick={()=>handleDelete(post)} className="font-inter text-sm orange_gradient cursor-pointer">
                        Delete
                    </div>
                </div>
            )
